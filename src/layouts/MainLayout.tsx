            ...
            <header className="bg-gradient-to-r from-[#6366f1] to-blue-700 shadow-xl sticky top-0 z-50">
                <div className="container mx-auto px-6 py-4 flex items-center justify-between relative">
                    ...
                    <div className="flex items-center space-x-6 text-white ml-auto">
                        <span className="text-sm font-semibold transition-all duration-300 transform hover:scale-105 hover:opacity-90">
                            John Doe
                            <div className="text-gray-300 text-xs transition-all duration-300 hover:text-white">
                                JohnDoe@gmail.com
                            </div>
                        </span>
                        ...
                        <div className="relative group">
                            <UserCircle 
                                className="h-10 w-10 text-gray-200 transition-all duration-500 transform group-hover:rotate-12 group-hover:scale-110 group-hover:shadow-lg" 
                            />
